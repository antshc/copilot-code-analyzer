...
rm -rf "$REPORT_OUT"
mkdir -p "$REPORT_OUT"
FORMAT_PROMPT=$(curl -fsSL https://github.com/antshc/copilot-code-analyzer/blob/main/prompts/format.prompt.md)
...
#copilot -p "$FORMAT_PROMPT @$REPORT_OUT/format-report.json. Save output in the file format-report.md" --yolo --model gpt-5.2
